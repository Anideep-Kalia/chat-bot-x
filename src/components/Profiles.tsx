...
function Profiles({ onProfileClick }: ProfilesProps) {
  ...
  return (
    <div className="min-h-screen w-full p-4">
      <div className="w-full max-w-4xl mx-auto bg-gradient-to-b from-stone-950 to-stone-900 rounded-lg p-6 flex flex-col border border-stone-800"> {/* Modified this line */}
        <h1 className="text-2xl font-light text-stone-200 text-center mb-4">Latest User Profiles</h1>
